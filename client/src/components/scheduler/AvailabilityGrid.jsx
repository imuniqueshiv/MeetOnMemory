...
const AvailabilityGrid = ({
  ...
  const handleConfirm = useCallback(
    (slot) => {
      ...
      if (slot.status === "conflicted") {
        setError(
          "This slot has significant conflicts. Please review conflicts before confirming.",
        );
        return;
      }
  ...
  if (!isConnected) {
    return (
      <div
        className={`bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-8 ${className}`}
      >
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            To view availability and find optimal meeting times, please connect
            your calendar account. This allows us to check your schedule and
            avoid conflicts.
          </p>
          <button
      ...
      >
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            We couldn&apos;t find any optimal meeting times based on
              ...
              >
                ...
                <div>
                  <span className="font-medium">
                    {conflict.participants?.join(", ") || "Participant"}
                  </span>
                  {conflict.time && (
