...
assert.strictEqual(
  ...
  "function",
  "transporter should have a sendMail function",
);
assert.strictEqual(
  typeof transporter.verify,
  "function",
  "transporter should have a verify function",
);
...
assert.strictEqual(
  ...
  true,
  "verify callback should be called immediately in mock mode",
);
...
assert.ok(
  mockResult.messageId.startsWith("mock-id-"),
  "mock result should return a mock-id",
);
