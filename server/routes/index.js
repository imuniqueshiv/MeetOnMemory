...
import decisionMatrixRoutes from "./decisionMatrixRoutes.js";
import meetingCostEngineRoutes from "./meetingCostEngineRoutes.js";
import complianceMatrixRoutes from "./complianceMatrixRoutes.js";
...
import okrRoutes from "./okrRoutes.js";
...
router.use("/api/decision-matrix", decisionMatrixRoutes);
router.use("/api/cost-engine", meetingCostEngineRoutes);
router.use("/api/compliance", complianceMatrixRoutes);
router.use("/api/okrs", okrRoutes);
